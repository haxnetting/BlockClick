...
def main():
    ...
    while running:
        ...
        # Rysowanie linii
        pygame.draw.line(WIN, (0, 0, 0), (0, player.y - 1), (WIDTH, player.y - 1), 2)
        pygame.draw.line(WIN, (0, 0, 0), (0, player.y - 2), (WIDTH, player.y - 2), 2)

# Rysowanie obiektów
        WIN.blit(BACKGROUND_IMG, (0, 0))
        pygame.draw.line(WIN, (0, 0, 0), (0, 400), (WIDTH, 402), 2)
